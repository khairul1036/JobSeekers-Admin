					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Edit Event</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">Edit Event</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body text-center pt-0">
                                            ...
                                            <div class="image-input image-input-empty mb-3" data-kt-image-input="true" style="background-image: url(assets/media/svg/files/blank-image.svg)">
                                                ...
                                                <!-- Buttons for canceling or removing banner -->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <input type="text" name="event_name" class="form-control mb-2" placeholder="Event name" value="<?php echo $edit_event_name; ?>" />
                                                <div class="text-muted fs-7">An event name is required.</div>
                                            </div>
                                            <!-- Input group for event description -->
                                            <div>
                                                <label class="form-label">Description</label>
                                                <textarea id="" name="event_description" class="form-control mb-2"><?php echo $edit_event_description; ?></textarea>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <input type="text" class="form-control mb-2" name="organizer_name" placeholder="Organizer name" value="<?php echo $edit_organizer_name; ?>" />
                                                <div class="text-muted fs-7">Enter organizer's name.</div>
                                            </div>
                                            <!-- Input group for event location -->
                                            <div class="mb-10">
                                                <label class="form-label">Event Location</label>
                                                <textarea id="" name="event_location" class="form-control mb-2"><?php echo $edit_event_location; ?></textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" name="starting_date" class="form-control mb-2" value="<?php echo $edit_starting_date; ?>" />
                                                    <div class="text-muted fs-7">Start date of the event.</div>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="required form-label">End Date:</label>
                                                    <input type="date" name="ending_date" class="form-control mb-2" value="<?php echo $edit_ending_date; ?>" />
                                                    <div class="text-muted fs-7">End date of the event.</div>
                                                </div>
                                            </div>
                                            <!-- Input group for social link --><br><br>
                                            <div>
                                                <label class="form-label">Social Link</label>
                                                <input type="text" class="form-control mb-2" name="Edit_social_link" placeholder="Social Link" value="<?php echo $edit_socal_link; ?>" />
                                                <div class="text-muted fs-7">Set a list of social links for the event.</div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Button group for cancel and save -->
                                    <div class="d-flex justify-content-end">
                                        <a href="../../demo3/dist/apps/ecommerce/catalog/products.html" id="kt_ecommerce_Edit_product_cancel" class="btn btn-light me-5">Cancel</a>
