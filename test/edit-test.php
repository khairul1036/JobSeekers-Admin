...
if(isset($_GET['test_id'])) {
    // Retrieve the test_id from the URL
    $test_id = $_GET['test_id'];

    // Fetch test details based on the provided test_id
    ...
    // Redirect or display an error message if test_id is not provided in the URL
    header("Location: test.php"); 
    exit();
}
									...
									<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
										...
										<form method="post" class="form" action="test/backend_quiz.php">
											...
											<div class="d-flex flex-column mb-8 fv-row">
												...
												<!--end::Label-->
												<input type="text" class="form-control form-control-solid" placeholder="Test Name" value="<?php echo $row["test_name"] ?>" name="test_name" />
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
											<div class="row g-9 mb-8">
												...
												<div class="col-md-6 fv-row">
													...
													<div class="position-relative d-flex align-items-center">
														...
														<!--end::Icon-->
														<!--begin::Datepicker-->
														<input class="form-control form-control-solid ps-12" placeholder="Starting date" value="<?php echo $row["start_date"] ?>" name="start_date" type="date"/>
														<!--end::Datepicker-->
													</div>
													<!--end::Input-->
												</div>
												...
												<div class="col-md-6 fv-row">
													...
													<div class="position-relative d-flex align-items-center">
														...
														<!--end::Icon-->
														<!--begin::Datepicker-->
														<input class="form-control form-control-solid ps-12" placeholder="Ending date" value="<?php echo $row["end_date"] ?>" name="end_date" type="date"/>
														<!--end::Datepicker-->
													</div>
													<!--end::Input-->
												</div>
											...
											<div class="row g-9 mb-8">
												...
												<div class="col-md-6 fv-row">
													...
													<div class="position-relative d-flex align-items-center">
														...
														<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
														<span class="svg-icon svg-icon-2 position-absolute mx-4">
															<i class="material-icons" style="font-size:20px;color:#A1A5B7"></i>
														</span>
														<!--end::Svg Icon-->
														<!--end::Icon-->
														<!--begin::Datepicker-->
														<input class="form-control form-control-solid ps-12" placeholder="Start Time" value="<?php echo $row["start_time"] ?>" name="start_time" type="time"/>
														<!--end::Datepicker-->
													</div>
													<!--end::Input-->
												</div>
												...
												<div class="col-md-6 fv-row">
													...
													<div class="position-relative d-flex align-items-center">
														...
														<!--end::Icon-->
														<!--begin::Datepicker-->
														<input class="form-control form-control-solid ps-12" placeholder="End Time" value="<?php echo $row["end_time"] ?>" name="end_time" type="time"/>
														<!--end::Datepicker-->
													</div>
													<!--end::Input-->
												</div>
											...
											<div class="d-flex flex-column mb-8">
												...
												<textarea class="form-control form-control-solid" rows="3" name="test_details" placeholder="Test Details"><?php echo $row["test_details"] ?></textarea>
											</div>
											<!--end::Input group-->
											<!--begin::Input group-->
											<div class="row g-9 mb-8">
												...
												<div class="col-md-6 fv-row">
													...
													<!--end::Label-->
													<input class="form-control form-control-solid" value="<?php echo $row["subject"] ?>" name="subject" />
												</div>
												<!--begin::Input group-->
												<div class="col-md-6 fv-row">
													<!--begin::Label-->
													...
													<!--end::Label-->
													<input class="form-control form-control-solid" value="<?php echo $row["duration"] ?>" name="duration" type="number" />
												</div>
												<!--end::Input group-->
											</div>
											<!--begin::Actions-->
