					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Reply</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								...
								<div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
									...
									<div class="card">
										<div class="card-header align-items-center py-5 gap-5">
											...
											<div class="d-flex">
												<!--begin::Back-->
												<a href="../../demo3/dist/apps/inbox/listing.html" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Back">
										...
										<div class="card-body">
											...
											<div data-kt-inbox-message="message_wrapper">
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														<!--begin::Date-->
														<span class="fw-bold text-muted text-end me-3">15 Apr 2022, 10:30 am</span>
														<!--end::Date-->
														<div class="d-flex">
															<!--begin::Star-->
											...
											<div data-kt-inbox-message="message_wrapper">
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														<!--begin::Date-->
														<span class="fw-bold text-muted text-end me-3">24 Jun 2022, 2:40 pm</span>
														<!--end::Date-->
														<div class="d-flex">
															<!--begin::Star-->
															<a href="#" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Star">
											...
											<div data-kt-inbox-message="message_wrapper">
												...
												<div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer" data-kt-inbox-message="header">
													...
													<div class="d-flex align-items-center flex-wrap gap-2">
														<!--begin::Date-->
														<span class="fw-bold text-muted text-end me-3">21 Feb 2022, 5:20 pm</span>
														<!--end::Date-->
														<div class="d-flex">
															<!--begin::Star-->
															<a href="#" class="btn btn-sm btn-icon btn-clear btn-active-light-primary me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Star">
