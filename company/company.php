					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Company List</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar">
										<!--begin::Add customer-->
										<a href="company/add_company.php" class="btn btn-primary">Add Company</a>
										<!--end::Add customer-->
									</div>
									<!--end::Card toolbar-->
								</div>
										...
										<tbody class="fw-bold text-gray-600">
											...
											if ($result->num_rows > 0) {
												while($row = $result->fetch_assoc()) {
													...
													echo "<td><div class='d-flex'><div class='ms-5'><a href='company/view_company.php?company_id=" . $row["company_id"] . "' class='text-gray-800 text-hover-primary fs-5 fw-bolder mb-1' data-kt-ecommerce-category-filter='category_name'>" . $row["company_name"] . "</a><div class='text-muted fs-7 fw-bolder'>" . $row["company_description"] . "</div></div></div></td>";
													...
													echo "<td class='text-end'>
															<div class='dropdown'>
																...
																<li><a class='dropdown-item' href='company/edit-company.php?company_id=" . $row["company_id"] . "'>Edit</a></li>
																	<li>
																		<form method='POST' action='company/backend_company.php'>
																			<input type='hidden' name='delete_company_data' value='1'>
