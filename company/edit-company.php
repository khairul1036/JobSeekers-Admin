...
if(isset($_GET['company_id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $edit_company_description = $row['company_description'];
        $edit_website_link = $row['website_link'];
        $edit_company_location = $row['company_location'];
        $edit_company_type = $row['company_type'];
        $edit_social_link = $row['social_link'];
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-xxl" id="kt_content_container">
							<form action="company/backend_company.php" method="POST" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="">
								<!--begin::Aside column-->
								<input type="hidden" name="edit_company_data" value= "1">
								...
								<div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
									...
									<div class="card card-flush py-4">
										...
										<div class="card-body pt-0">
											<!--begin::Select2-->
											<select name="edit_status" class="form-select mb-2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select" >
												<option value="published" <?php if ($edit_status == "published") echo "selected"; ?> >published</option>
												<option value="unpublished" <?php if ($edit_status == "unpublished") echo "selected"; ?> >unpublished</option>

											</select>
											<!--end::Select2-->

											<!--begin::Description-->
											<div class="text-muted fs-7">Set the company status.</div>
											<!--end::Description-->
										</div>
										<!--end::Card body-->
									</div>
									...
									<div class="card card-flush py-4">
										...
										<div class="card-body pt-0">
											...
											<div class="mb-10 fv-row">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" name="edit_company_name" class="form-control mb-2" placeholder="Company name" value="<?php echo htmlspecialchars($edit_company_name); ?>" />
												<!--end::Input-->
												<!--begin::Description-->
											...
											<div>
												...
												<!--end::Label-->
												<!--begin::Editor-->
												<textarea id="" name="edit_company_description" class="form-control mb-2" value="<?php echo htmlspecialchars($edit_company_description); ?>"><?php echo htmlspecialchars($edit_company_description); ?></textarea>
												<!--end::Editor-->
												<!--begin::Description-->
									...
									<div class="card card-flush py-4">
										...
										<div class="card-body pt-0">
											...
											<div class="mb-10">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" class="form-control mb-2" name="edit_website_link" placeholder="techinnovations.inc" value="<?php echo htmlspecialchars($edit_website_link); ?>" />
												<!--end::Input-->
												<!--begin::Description-->
											...
											<div class="mb-10">
												...
												<!--end::Label-->
												<!--begin::Editor-->
												<textarea id="" name="edit_company_location" class="form-control mb-2" value="<?php echo htmlspecialchars($edit_company_location); ?>"><?php echo htmlspecialchars($edit_company_location); ?></textarea>
												<!--end::Editor-->
												<!--begin::Description-->
											...
											<div class="mb-10 fv-row">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" name="edit_company_type" class="form-control mb-2" placeholder="Company Type" value="<?php echo htmlspecialchars($edit_company_type); ?>" />
												<!--end::Input-->
												<!--begin::Description-->
											...
											<div>
												...
												<!--end::Label-->
												<!--begin::Editor-->
												<input type="text" class="form-control mb-2" name="edit_social_link" placeholder="Social Link" value="<?php echo htmlspecialchars($edit_social_link); ?>" />
												<!--end::Editor-->
												<!--begin::Description-->
												<div class="text-muted fs-7">Set a socal link that the company have.</div>
												<!--end::Description-->
											</div>
											<!--end::Input group-->
										</div>
