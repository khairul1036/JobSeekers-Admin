					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Online Fair Application List</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								...
								<div class="card-body py-4">
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
										...
										<tbody class="text-gray-600 fw-bold">
											...
											// echo " online_fair_job_id: ". $online_fair_job_id;
											...
											$q2 = "SELECT job_title FROM online_fair_job_posts WHERE online_fair_job_id = $online_fair_job_id"; 
											$r2 = $conn->query($q2);											
											$singleRow2 = $r2->fetch_assoc(); // Fetch a single row as an associative array
											echo "<p class='h6 text-black-50'>Job Name: ".$singleRow2["job_title"]."</p>";
											
											// Fetch data from the Applications table
											$sql = "SELECT * FROM onlinefairapplications WHERE company_id=$company_id AND OJF_Job_post_id=$online_fair_job_id AND JobFair_id=$online_fair_id ;";
											...
											if ($result->num_rows > 0) {
												...
												while ($row = $result->fetch_assoc()) {
													$OJF_job_application_id = $row["OJF_job_application_id"];
													$user_id = $row["user_id"];

													$q3 = "SELECT * FROM jobseeker_register_info WHERE user_id = $user_id"; 
													$r3 = $conn->query($q3);											
													$row3 = $r3->fetch_assoc();
													//echo $row3["name"];
													...
													echo '<tr>
														<td>
															<div class="form-check form-check-sm form-check-custom form-check-solid">
																<input class="form-check-input" type="checkbox" value="' .$OJF_job_application_id. '" />
															</div>
														</td>
															...
															<div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
																<a href="job_post_application/view_user.php">
																	<div class="symbol-label">
																		<img src="assets/media/avatars/300-6.jpg" alt="' . $row3["name"] . '" class="w-100" />
																	</div>
																</a>
															</div>
															<div class="d-flex flex-column">
																<a href="job_post_application/view_user.php?user_id=' . $row['user_id'] . '" class="text-gray-800 text-hover-primary mb-1">' . $row3["name"] . '</a>
															</div>
														</td>
														<td>' . $row3["phone_no"] . '</td>
														<td>' . $row3["address"] . '</td>
																...
																<ul class='dropdown-menu'>
																	...
																	<li>
																		<form method='POST' action='job_post_application/backend_application.php'>
																			...
																			<input type='hidden' name='application_id' value='" . $OJF_job_application_id . "'>
