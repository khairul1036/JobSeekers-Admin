					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Add Online Fair</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">Add Online Fair</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-xxl" id="kt_content_container">
							<form action="online_fair/backend_online_fair.php" method="get" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="">
								<!--begin::Aside column-->
								<input type="hidden" name="add_online_fair_data" value="1">
								...
								<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
									...
									<div class="card card-flush py-4">
										...
										<div class="card-body pt-0">
											...
											<div class="mb-10 fv-row">
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input type="text" name="online_fair_name" class="form-control mb-2" placeholder="" value="" />
												<!--end::Input-->
												<!--begin::Description-->
											...
											<div>
												...
												<!--end::Label-->
												<!--begin::Editor--><br>
												<textarea id="text" name="online_fair_description" class="form-control mb-2"></textarea>
												<!--end::Editor-->
												<!--begin::Description-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="date" name="start_date" class="form-control mb-2" value="" />
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="date" name="end_date" class="form-control mb-2" value="" />
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
									...
									<div class="d-flex justify-content-end">
										...
										<button type="submit" id="" class="btn btn-primary">
											<span class="indicator-label" name="add_online_fair_data">Save</span>
