					...
					<div id="kt_header" class="header">
						...
						<div class="container d-flex flex-stack flex-wrap gap-2" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Online Fair Apply Company List</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
								<ul class="breadcrumb breadcrumb-dot fw-bold fs-base my-1">
									...
									<li class="breadcrumb-item text-dark">Online Fair Apply Company List</li>
								</ul>
								<!--end::Breadcrumb-->
							</div>
							<!--end::Page title=-->
							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar">
										<!--begin::Add customer-->
										<a href="company/add_company.php" class="btn btn-primary">Add New Company</a>
										<!--end::Add customer-->
									</div>
									<!--end::Card toolbar-->
								</div>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
										...
										<tbody class="fw-bold text-gray-600">
											...
											if(isset($_GET['online_fair_id'])) {
												...
												echo "<p class='h2'>".$singleRow["online_fair_name"]."</p>";
												// Now you can use $online_fair_id in your code
												//echo "Online Fair ID: " . $online_fair_id;
											} 
											 if (isset($_GET['error'])) { 
												echo "<p class='alert alert-danger' role='alert'>".$_GET["error"]."</p>";
											} else if (isset($_GET['success'])) { 
												echo "<p class='alert alert-success' role='alert'>".$_GET["success"]."</p>";
											} 
											...
											if ($result->num_rows > 0) {
												while($row = $result->fetch_assoc()) {
													...
													echo "<td><div class='d-flex'><div class='ms-5'><a href='company/view_company.php?company_id=" . $row["company_id"] . "' class='text-gray-800 text-hover-primary fs-5 fw-bolder mb-1' data-kt-ecommerce-category-filter='category_name'>" . $row["company_name"] . "</a><div class='text-muted fs-7 fw-bolder'>" . $row["company_location"] . "</div></div></div></td>";
													echo "<td><div class='badge badge-light-success'>" . $row["company_type"] . "</div></td>";
													//echo "<td class='btn btn-info'><a href='online_fair/backend_online_fair.php?online_fair_id=".$online_fair_id."&company_id=".$row["company_id"]."' style='color: white;'>Add</a></td>";
													if($row["status"]==1){
														echo "<td class='btn btn-info'><a href='online_fair/backend_online_fair.php?online_fair_id=".$online_fair_id."&company_id=".$row["company_id"]."&status=0 ' style='color: white;'>Add</a></td>";
													}else{
														echo "<td class='btn btn-secondary'><a href='online_fair/backend_online_fair.php?online_fair_id=".$online_fair_id."&company_id=".$row["company_id"]."&status=1 ' style='color: #6C6C6C;'>Added</a></td>";
													}
