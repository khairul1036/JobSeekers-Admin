							...
							<div class="card card-flush">
								...
								<div class="card-header align-items-center py-5 gap-2 gap-md-5">
									...
									<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
										...
										<!--begin::Add Job Post-->
										<a href="job_post/create_job_post.php" class="btn btn-primary">Add Job Post</a>
										<!--end::Add Job Post-->
									</div>
									<!--end::Card toolbar-->
								</div>
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
										...
										<thead>
											...
											<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
												...
												<th class="text-end min-w-100px">Company</th>
												<th class="text-end min-w-70px">Job Type</th>
												<th class="text-end min-w-100px">Salary</th>
												<th class="text-end min-w-100px">Workplace Type</th>
												<th class="text-end min-w-100px">Last Date</th>
										...
										if ($result->num_rows > 0) {
											...
											while ($row = $result->fetch_assoc()) {
												...
												$company_name = $row["company_name"]; // Use company name instead of company ID
												...
												// Prepare SQL query
												$sql = "SELECT COUNT(*) AS count FROM applications WHERE JobPostID = ?";
												...
												echo '<td>
														<div class="d-flex align-items-center">
															<a href="job_post_application/all_application.php?job_id='.$job_id.'" class="symbol symbol-50px">
															</a>
															<div class="ms-5">
																<a href="job_post_application/all_application.php?job_id='.$job_id.'" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">'.$job_title.'</a>
															</div>
														</div>
													</td>';
												echo '<td class="text-end pe-0">'.$company_name.'</td>'; // Display company name
												echo '<td class="text-end pe-0">'.$job_type.'</td>';
												echo '<td class="text-end pe-0">'.$salary.'</td>';
												echo '<td class="text-end pe-0">'.$workplace_type.'</td>';
												echo '<td class="text-end pe-0">'.$deadline.'</td>';
												echo '<td class="text-end pe-0 fw-bolder">'.$applied.'</td>';
												echo "<td class='text-end'>
														<div class='dropdown'>
															...
															<ul class='dropdown-menu'>
																<li><a class='dropdown-item' href='job_post/view_job_post.php?job_id=" . $job_id . "'>View</a></li>
																<li><a class='dropdown-item' href='job_post/edit-job_post.php?job_id=" . $job_id . "'>Edit</a></li>
																<li>
