...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["create_job_post"])) {
    ...
    // Retrieve the company ID from the form
    ...
    $sql = "INSERT INTO job_posts (job_id, company_id, job_title, workplace_type, location, education_level, job_type, salary, job_description, job_responsibilities, job_requirement, additional_requirement, vacancies, employment_type, gender, experience, benefits, deadline, publish_status, read_before_apply, quiz, online_interview, offline_interview, additional_info)  
            VALUES ('$job_id', '$company_id', '$job_title', '$workplace_type', '$location', '$education', '$job_type', '$salary', '$job_description', '$job_responsibilities', '$job_requirement', '$additional_requirement', '$vacancies', '$employment_type', '$gender', '$experience', '$benefits', '$deadline', '$publish_status', '$read_before_apply', '$quiz', '$online_interview', '$offline_interview', '$additional_info')";
