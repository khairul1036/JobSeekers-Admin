...
if (isset($_GET['job_id'])) {
    $job_id = $_GET['job_id'];  // Convert to integer for security

    // Prepare the SQL statement to retrieve data
    $stmt = $conn->prepare("SELECT * FROM set_quiz WHERE job_id = ?");
    if ($stmt) {
...
<html lang="en">
	...
	<body id="kt_body">
								...
								<div class="card-header border-0 pt-6">
									...
									<div class="card-toolbar">
										...
										<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
											...
											if($btn==55) {?>
												<button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_add_quiz" >Quiz</button>
												<?php
											}
											else{
											?>
												<button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_quiz" >Edit Quiz</button>
											<?php } ?>
											<!--begin::Filter-->
								...
								<div class="card-body py-4">
									...
									<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
										...
										<tbody class="text-gray-600 fw-bold">
											...
											WHERE a.condition='requesting' AND a.JobPostID='$job_id';										
											";
		...
		<div class="modal fade" id="kt_modal_add_quiz" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
			<div class="modal-dialog modal-dialog-centered mw-650px">
				...
				<div class="modal-content rounded">
					...
					<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
						<!--begin:Form-->
						<form id="kt_modal_new_target_form" class="form" method="get" action="job_post_application/backend_application.php">
							<input type="hidden" name="set_quiz" value="1">
							...
							<div class="d-flex flex-column mb-8 fv-row">
								...
								<label class="d-flex align-items-center fs-6 fw-bold mb-2">
									<span class="required">Select Test</span>
									<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Specify a target name for future usage and reference"></i>
								</label>
								<!--begin::Select-->
								<select name="set_quiz" class="form-control form-control-solid" data-placeholder="Select Quiz" id="quiz_select">
							...
							<div class="row g-9 mb-8">
								...
								<div class="col-md-6 fv-row">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="Starting date" name="start_date" type="date"/>
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
								...
								<div class="col-md-6 fv-row">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="Ending date" name="end_date" type="date"/>
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
							...
							<div class="row g-9 mb-8">
								...
								<div class="col-md-6 fv-row">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
										<span class="svg-icon svg-icon-2 position-absolute mx-4">
											<i class="material-icons" style="font-size:20px;color:#A1A5B7">access_time</i>
										</span>
										<!--end::Svg Icon-->
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="Start Time" name="start_time" type="time"/>
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
								...
								<div class="col-md-6 fv-row">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="End Time" name="end_time" type="time"/>
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
		...
		<!--begin::Modal - New Target-->
		<div class="modal fade" id="kt_modal_edit_quiz" tabindex="-1" aria-hidden="true">
			<!--begin::Modal dialog-->
			<div class="modal-dialog modal-dialog-centered mw-650px">
				<!--begin::Modal content-->
				<div class="modal-content rounded">
					...
					<div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
						<!--begin:Form-->
						<form id="kt_modal_new_target_form" class="form" method="post" action="job_post_application/backend_application.php">
							<input type="hidden" name="edit_set_quiz" value="1">
							<input type="hidden" name="job_id" value="<?php echo $job_id ?>">
							<!--begin::Heading-->
							<div class="mb-13 text-center">
								<!--begin::Title-->
							...
							<div class="d-flex flex-column mb-8 fv-row">
								...
								<!--begin::Select-->
								<select name="set_quiz" class="form-control form-control-solid" data-placeholder="Select Quiz" value="<?php echo $test_id ?>" id="quiz_select">
										<option value="">Select Quiz</option>
										<?php
										// Fetch company names from the database and populate the options
										$sql = "SELECT test_id, test_name FROM tests";
							...
							<div class="row g-9 mb-8">
								...
								<div class="col-md-6 fv-row">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="Starting date" value="<?php echo $start_date ?>" name="start_date" type="date"/>
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
								...
								<div class="col-md-6 fv-row">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="Ending date" value="<?php echo $end_date ?>" name="end_date" type="date"/>
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
							...
							<div class="row g-9 mb-8">
								...
								<div class="col-md-6 fv-row">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="Start Time" value="<?php echo $start_time ?>" name="start_time" type="time"/>
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
								...
								<div class="col-md-6 fv-row">
									...
									<div class="position-relative d-flex align-items-center">
										...
										<!--end::Icon-->
										<!--begin::Datepicker-->
										<input class="form-control form-control-solid ps-12" placeholder="End Time" value="<?php echo $end_time ?>" name="end_time" type="time"/>
										<!--end::Datepicker-->
									</div>
									<!--end::Input-->
								</div>
